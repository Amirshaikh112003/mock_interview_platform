            ...
            <div className="card-interview">
                <div>
                    ...
                    <Image src={getRandomInterviewCover()} alt="cover image"
                           width={90} height={90} className="rounded-full object-fit size-[90-px]"  />

                    <h3 className="mt-5 cpatilize">
                        {role} Interview
                    </h3>

                    <div className="flex flex-row gap-5 mt-3">
                        <div className="flex flex-row gap-2">
                            <Image src="/calander.svg" alt="calander"
                            width={22} height={22} />
                            <p>{formattedDate}</p>
                        </div>
                        <div className="flex flex-row gap-2
                    ...
                    <p className="line-clamp-2 mt-5">
                        {feedback?.finalAssessment || "You haven't " +
                            "taken an interview yet. Take it now to improve your skills"}
                    </p>
                </div>
